...
class RelatedConcert extends StatefulWidget {
  var data;

  RelatedConcert({this.data});

  @override
  _WebRelatedConcertState createState() => _WebRelatedConcertState();
}

class _WebRelatedConcertState extends State<RelatedConcert> {
